...
namespace TriVoiture
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                Array.Sort(TableauVoitures, ComparePuissance);
                Console.WriteLine(Environment.NewLine);
            ...
            try
            {
                ListeVoitures.Sort(ComparePuissance);
                Console.WriteLine(Environment.NewLine);
            ...
            {
                Console.WriteLine(Environment.NewLine);
                Console.WriteLine("Impossible de faire le tri de la liste. Quelle critère de comparaison?");
